...
<script type="text/javascript">
	...
	$loginForm = $("form[name='loginForm']").submit(function(){
	...
	function submitLogin(){
		...
		if (flag)
		{
			$.ajax({
				   ...
				   data: {"sn":sn,"password":password,"random":random},
				   dataType:"json",
...
<body onload="check()">
	...
	<div class="login-area">
		<form action="" method="post" name = "loginForm">
			...
			<input type="text" name="random" size="6" id = "random" />
			<img src="random.action"
				onclick="changeValidateCode(this)" title="点击图片刷新验证码" />
			<input type="button" class="login-sub" value="" onclick = "submitLogin()"/>
