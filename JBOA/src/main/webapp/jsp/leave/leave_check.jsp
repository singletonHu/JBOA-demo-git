	...
	<head>
		...
		<script type="text/javascript">
			function checkLeave(status){
		   		...
		   		document.leaveForm.status.value = status=="审批通过"?"2":"3";
		...
		<div class="action  divaction">
			...
			<div class="pages">
				...
				<table width="90%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td>
							开始时间：<s:date name="leave.startTime" format="yyyy-MM-dd HH:mm:ss"/>
						</td>
						<td>
							结束时间：<s:date name="leave.endTime" format="yyyy-MM-dd HH:mm:ss"/>
						</td>
					</tr>
					<tr>
						<td>
				...
				<s:form action="leave_checkLeave.action" name="leaveForm" method="post">
				<table width="90%" border="0" cellspacing="0" cellpadding="0"
					class="addform-base">
					<tr>
						<td>
					...
					<tr>
						<td colspan="4" class="submit">
							...
							class="submit_01" onclick="checkLeave(this.value)" />
